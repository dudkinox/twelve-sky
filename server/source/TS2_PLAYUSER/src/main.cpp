...
static void load_config(void) 
{
	...
	::snprintf(mSERVER_INFO.mDB_1_Table01, 100, "%s", "DefineMaxUserNum");
	::snprintf(mSERVER_INFO.mDB_1_Table02, 100, "%s", "HackInfo");
	::snprintf(mSERVER_INFO.mDB_1_Table03, 100, "%s", "BadUserInfo");
	::snprintf(mSERVER_INFO.mDB_1_Table04, 100, "%s", "BadUserList");
#ifdef __EVENT_KILL__
	::snprintf(mSERVER_INFO.mDB_1_Table05, 100, "%s", "EventKillInfo");
#elif __EVENT_GOLD_PHONE__
	::snprintf(mSERVER_INFO.mDB_1_Table05, 100, "%s", "EventGoldPhoneInfo");
#else
	::snprintf(mSERVER_INFO.mDB_1_Table05, 100, "%s", "");
#endif
	::snprintf(mSERVER_INFO.mDB_1_Table06, 100, "%s", "EventInfo");
	::snprintf(mSERVER_INFO.mDB_1_Table07, 100, "%s", "MasterInfo");
	::snprintf(mSERVER_INFO.mDB_1_Table08, 100, "%s", "TribeInfo");
	::snprintf(mSERVER_INFO.mDB_1_Table09, 100, "%s", "AvatarInfo");
	::snprintf(mSERVER_INFO.mDB_1_Table10, 100, "%s", "AutoUserList");
	::snprintf(mSERVER_INFO.mDB_2_Table01, 100, "%s", "MemberInfo");
	::snprintf(mSERVER_INFO.mDB_2_Table02, 100, "%s", "MemberAuth");
	::snprintf(mSERVER_INFO.mDB_2_Table03, 100, "%s", "AvatarNameInfo");
	::snprintf(mSERVER_INFO.mDB_2_Table04, 100, "%s", "RankInfo");
	::snprintf(mSERVER_INFO.mDB_2_Table05, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_2_Table06, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_2_Table07, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_2_Table08, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_2_Table09, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_2_Table10, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table01, 100, "%s", "t_log_gamelog");
	::snprintf(mSERVER_INFO.mDB_3_Table02, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table03, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table04, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table05, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table06, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table07, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table08, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table09, 100, "%s", "");
	::snprintf(mSERVER_INFO.mDB_3_Table10, 100, "%s", "");

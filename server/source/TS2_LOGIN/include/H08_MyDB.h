...
#ifdef __CHANNEL__
	void DB_PROCESS_02( char tIP[16], char tID[MAX_USER_ID_LENGTH], char tPassword[MAX_USER_PASSWORD_LENGTH], char uID[MAX_USER_ID_LENGTH], int *tCheckMOTP, char tMousePassword[MAX_MOUSE_PASSWORD_LENGTH], int *tSecretCard, int *tUserSort, int *tGoodFellow, int *tLoginPlace, int *tLoginPremium, int *tTraceState, char *tBonus100Money, int *tSaveMoney, int tSaveItem[MAX_SAVE_ITEM_SLOT_NUM][4], AVATAR_INFO tAvatarInfo[MAX_USER_AVATAR_NUM], AUTH_INFO *tAuthInfo, int *tResult, char *tFirstLogin, int tAdult );
#else 
	void DB_PROCESS_02( char tIP[16], char tID[MAX_USER_ID_LENGTH], char tPassword[MAX_USER_PASSWORD_LENGTH], char uID[MAX_USER_ID_LENGTH], int *tCheckMOTP, char tMousePassword[MAX_MOUSE_PASSWORD_LENGTH], int *tSecretCard, int *tUserSort, int *tGoodFellow, int *tLoginPlace, int *tLoginPremium, int *tTraceState, char *tBonus100Money, int *tPremiumServerExpirationDate, int *tSaveMoney, int tSaveItem[MAX_SAVE_ITEM_SLOT_NUM][4], AVATAR_INFO tAvatarInfo[MAX_USER_AVATAR_NUM], AUTH_INFO *tAuthInfo, int *tResult, char *tFirstLogin ); // 함수 선언 수정 - int *tPremiumServerExpirationDate 추가. // @_Premium_Server_@
#endif

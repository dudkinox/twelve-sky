...
public :
	...
	void B_LOGIN_RECV( int tResult, char tID[MAX_USER_ID_LENGTH], int tUserSort, int tGoodFellow, int tLoginPlace, int tLoginPremium, int tLoginPremiumPCRoom, int tSecondLoginSort, char tMousePassword[MAX_MOUSE_PASSWORD_LENGTH], int tSecretCardIndex01, int tSecretCardIndex02, char tFirstLogin = '0' );
	...
	void B_DEMAND_ZONE_SERVER_INFO_1_RESULT( int tResult, char tIP[16], int tPort );

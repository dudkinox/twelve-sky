...
/* This one looks for trouble in 21 dimensions. It is only likely to catch */
/* the grossest ugliness, but should be good enough for a lagged */
/* Fibonacci with both lags less than about 20. */
...
dobuf(double b[], int s)
{
    ...
    for (i= -DIM; i<0; i++) index=(b[i]>0.5)+2*index;

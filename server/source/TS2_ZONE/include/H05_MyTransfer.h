...
public :
	...
	void B_REGISTER_AVATAR_RECV( AVATAR_INFO *tAvatarInfo, int tEffectValue[MAX_AVATAR_EFFECT_SORT_NUM][2], int tPremiumServerExpirationDate ); // 함수 선언 수정 - int tPremiumServerExpirationDate 추가. // @_Premium_Server_@
	...
	void B_END_PSHOP_RECV( void );
	void B_DEMAND_PSHOP_RECV( int tResult, PSHOP_INFO *tPShopInfo );
	void B_PSHOP_ITEM_INFO_RECV( DWORD tUniqueNumber, char tAvatarName[MAX_AVATAR_NAME_LENGTH], int tPage, int tIndex, int tPShopItemInfo[9] );
	void B_BUY_PSHOP_RECV( int tResult, int tCost, int tPage, int tIndex, int tValue[6] );
	...
	void B_SECRET_CHAT_RECV( int tResult, int tZoneNumber, char tAvatarName[MAX_AVATAR_NAME_LENGTH], char tContent[MAX_CHAT_CONTENT_LENGTH], BYTE tAuthType, int type = 0 );
	...
	void B_TRADE_START_RECV( int tTradeMoney, int tTrade[MAX_TRADE_SLOT_NUM][4] );
	void B_TRADE_STATE_RECV( int tTradeMoney, int tTrade[MAX_TRADE_SLOT_NUM][4] );
	...
	void B_PARTY_INFO_RECV( char tAvatarName01[MAX_AVATAR_NAME_LENGTH], char tAvatarName02[MAX_AVATAR_NAME_LENGTH], char tAvatarName03[MAX_AVATAR_NAME_LENGTH], char tAvatarName04[MAX_AVATAR_NAME_LENGTH], char tAvatarName05[MAX_AVATAR_NAME_LENGTH], int type = 0 );
	void B_PARTY_BREAK_RECV( char tAvatarName[MAX_AVATAR_NAME_LENGTH], int type = 0 );
	...
	void B_TRIBE_NOTICE_RECV( char tAvatarName[MAX_AVATAR_NAME_LENGTH], char tContent[MAX_CHAT_CONTENT_LENGTH], int type = 0 );
...
#endif
	void B_ITEM_LIKE_1336_RECV(int *tCount, int *tPage, int *tInvenSlot, int *tInvenIndex, int (*tItemList)[2], int *tItemValue, int *tItemRecognitionNum);
    ...
    // @ Cost Info Download @
    void B_GET_CASH_ITEM_INFO_RECV(int tResult, int tVersion, const int tCashItemInfo[4][10][10][4]);

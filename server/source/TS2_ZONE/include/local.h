...
typedef struct __g_env
{
	...
	int    premium_server; // @_Premium_Server_@
	float GeneralExperienceUpRatio;
	float ItemDropUpRatio;
	float ItemDropUpRatioForMyoung;
	int KillOtherTribeAddValue;
	int TeacherPointUpRatio;
	float PatExperienceUpRatio;
	float BonusGainGeneralExperienceUpRatio;
	int GeneralExperienceDownRatio;
	int KillOtherTribeExperienceUpRatio;
} _g_env;
...
#define CONFIG_KEY_GENERAL_EXPERIENCE_UP_RATIO        "GENERAL_EXPERIENCE_UP_RATIO"
#define CONFIG_KEY_ITEM_DROP_UP_RATIO                 "ITEM_DROP_UP_RATIO"
#define CONFIG_KEY_ITEM_DROP_UP_RATIO_FOR_MYOUNG      "ITEM_DROP_UP_RATIO_FOR_MYOUNG"
#define CONFIG_KEY_KILL_OTHER_TRIBE_ADD_VALUE         "KILL_OTHER_TRIBE_ADD_VALUE"
#define CONFIG_KEY_TEACHER_POINT_UP_RATIO             "TEACHER_POINT_UP_RATIO"
#define CONFIG_KEY_PAT_EXPERIENCE_UP_RATIO            "PAT_EXPERIENCE_UP_RATIO"
#define CONFIG_KEY_BONUS_GAIN_GENERAL_EXPERIENCE_UP_RATIO           "BONUS_GAIN_GENERAL_EXPERIENCE_UP_RATIO"
#define CONFIG_KEY_GENERAL_EXPERIENCE_DOWN_RATIO                    "GENERAL_EXPERIENCE_DOWN_RATIO"
#define CONFIG_KEY_KILL_OTHER_TRIBE_EXPERIENCE_UP_RATIO             "KILL_OTHER_TRIBE_EXPERIENCE_UP_RATIO"
...
#define CONFIG_KEY_PREMIUM_SERVER                     "PREMIUM_SERVER" // @_Premium_Server_@

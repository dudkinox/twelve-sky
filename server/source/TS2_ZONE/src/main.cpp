...
static void load_config(void) 
{
	...
	if (ret_val != 37) {
#else 
	if (ret_val != 30) { // 프리미엄 서버 여부 값 추가로 인해 +1 // @_Premium_Server_@
#endif
	...
	char GeneralExperienceUpRatio[MAX_SIZE_OF_CONFIG_ENTRY]; // @_Premium_Server_@
	char ItemDropUpRatio[MAX_SIZE_OF_CONFIG_ENTRY]; // @_Premium_Server_@
	char ItemDropUpRatioForMyoung[MAX_SIZE_OF_CONFIG_ENTRY]; // @_Premium_Server_@
	char KillOtherTribeAddValue[MAX_SIZE_OF_CONFIG_ENTRY]; // @_Premium_Server_@
	char TeacherPointUpRatio[MAX_SIZE_OF_CONFIG_ENTRY]; // @_Premium_Server_@
	char PatExperienceUpRatio[MAX_SIZE_OF_CONFIG_ENTRY]; // @_Premium_Server_@
	char BonusGainGeneralExperienceUpRatio[MAX_SIZE_OF_CONFIG_ENTRY]; // @_Premium_Server_@
	char GeneralExperienceDownRatio[MAX_SIZE_OF_CONFIG_ENTRY]; // @_Premium_Server_@
	...
	if(config_obj_ptr_drop->LoadConfig() < 0) {
		LOG_TO_BOTH("!drop okunmadi.\n");
		::exit(1);
	}


	config_obj_ptr_drop->GetValue(CONFIG_KEY_GENERAL_EXPERIENCE_UP_RATIO, GeneralExperienceUpRatio); // @GeneralExperienceUpRatio@
	config_obj_ptr_drop->GetValue(CONFIG_KEY_ITEM_DROP_UP_RATIO, ItemDropUpRatio); // @ItemDropUpRatio@
	config_obj_ptr_drop->GetValue(CONFIG_KEY_ITEM_DROP_UP_RATIO_FOR_MYOUNG, ItemDropUpRatioForMyoung); // @ItemDropUpRatioForMyoung@
	config_obj_ptr_drop->GetValue(CONFIG_KEY_KILL_OTHER_TRIBE_ADD_VALUE, KillOtherTribeAddValue); // @KillOtherTribeAddValue@
	config_obj_ptr_drop->GetValue(CONFIG_KEY_TEACHER_POINT_UP_RATIO, TeacherPointUpRatio); // @KillOtherTribeAddValue@
	config_obj_ptr_drop->GetValue(CONFIG_KEY_PAT_EXPERIENCE_UP_RATIO, PatExperienceUpRatio); // @PatExperienceUpRatio@
	config_obj_ptr_drop->GetValue(CONFIG_KEY_BONUS_GAIN_GENERAL_EXPERIENCE_UP_RATIO, BonusGainGeneralExperienceUpRatio); // @BonusGainGeneralExperienceUpRatio@
	config_obj_ptr_drop->GetValue(CONFIG_KEY_GENERAL_EXPERIENCE_DOWN_RATIO, GeneralExperienceDownRatio); // @GeneralExperienceDownRatio@
	config_obj_ptr_drop->GetValue(CONFIG_KEY_KILL_OTHER_TRIBE_EXPERIENCE_UP_RATIO, KillOtherTribeExperienceUpRatio); // @KillOtherTribeExperienceUpRatio@]
    


	g_env.GeneralExperienceUpRatio = ::atof(GeneralExperienceUpRatio); // @_Premium_Server_@
	g_env.ItemDropUpRatio = ::atof(ItemDropUpRatio); // @_Premium_Server_@
	g_env.ItemDropUpRatioForMyoung = ::atof(ItemDropUpRatioForMyoung); // @_Premium_Server_@
	g_env.KillOtherTribeAddValue = ::atoi(KillOtherTribeAddValue); // @_Premium_Server_@
	g_env.TeacherPointUpRatio = ::atoi(TeacherPointUpRatio); // @_Premium_Server_@
	g_env.PatExperienceUpRatio = ::atof(PatExperienceUpRatio); // @_Premium_Server_@
	g_env.BonusGainGeneralExperienceUpRatio = ::atof(BonusGainGeneralExperienceUpRatio); // @_Premium_Server_@
	g_env.GeneralExperienceDownRatio = ::atoi(GeneralExperienceDownRatio); // @_Premium_Server_@
	g_env.KillOtherTribeExperienceUpRatio = ::atoi(KillOtherTribeExperienceUpRatio); // @_Premium_Server_@

	mSERVER_INFO.x_mGeneralExperienceUpRatio = g_env.GeneralExperienceUpRatio;
	mSERVER_INFO.x_mItemDropUpRatio = g_env.ItemDropUpRatio;
	mSERVER_INFO.x_mItemDropUpRatioForMyoung = g_env.ItemDropUpRatioForMyoung;
	mSERVER_INFO.x_mKillOtherTribeAddValue = g_env.KillOtherTribeAddValue;
	mSERVER_INFO.x_mTeacherPointUpRatio = g_env.TeacherPointUpRatio;
	mSERVER_INFO.x_mPatExperienceUpRatio = g_env.PatExperienceUpRatio;
	mSERVER_INFO.x_mBonusGainGeneralExperienceUpRatio = g_env.BonusGainGeneralExperienceUpRatio;
	mSERVER_INFO.x_mGeneralExperienceDownRatio = g_env.GeneralExperienceDownRatio;
	mSERVER_INFO.x_mKillOtherTribeExperienceUpRatio = g_env.KillOtherTribeExperienceUpRatio;
...
int main(int argc, char **argv)
{
	...
	LOG_TO_BOTH_1("!GeneralExperienceUpRatio: %f\n", g_env.GeneralExperienceUpRatio);
	LOG_TO_BOTH_1("!ItemDropUpRatio: %f\n", g_env.ItemDropUpRatio);
	LOG_TO_BOTH_1("!ItemDropUpRatioForMyoung: %f\n", g_env.ItemDropUpRatioForMyoung);
	LOG_TO_BOTH_1("!KillOtherTribeAddValue: %d\n", g_env.KillOtherTribeAddValue);
	LOG_TO_BOTH_1("!TeacherPointUpRatio: %d\n", g_env.TeacherPointUpRatio);
	LOG_TO_BOTH_1("!PatExperienceUpRatio: %f\n", g_env.PatExperienceUpRatio);
	LOG_TO_BOTH_1("!BonusGainGeneralExperienceUpRatio: %f\n", g_env.BonusGainGeneralExperienceUpRatio);
	LOG_TO_BOTH_1("!GeneralExperienceDownRatio: %d\n", g_env.GeneralExperienceDownRatio);
	LOG_TO_BOTH_1("!KillOtherTribeExperienceUpRatio: %d\n", g_env.KillOtherTribeExperienceUpRatio);

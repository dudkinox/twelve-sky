...
void MyTransfer::B_REGISTER_AVATAR_RECV( AVATAR_INFO *tAvatarInfo, int tEffectValue[MAX_AVATAR_EFFECT_SORT_NUM][2], int tPremiumServerExpirationDate ) // 함수 선언 수정 - int tPremiumServerExpirationDate 추가. // @_Premium_Server_@
{
	...
	CopyMemory( &mOriginal[( 1 + sizeof( AVATAR_INFO ) + ( MAX_AVATAR_EFFECT_SORT_NUM * 8 ))], &tPremiumServerExpirationDate, 4 ); // @_Premium_Server_@
...
//B_END_PSHOP_RECV
void MyTransfer::B_END_PSHOP_RECV( void )
{
...
void MyTransfer::B_PSHOP_ITEM_INFO_RECV( DWORD tUniqueNumber, char tAvatarName[MAX_AVATAR_NAME_LENGTH], int tPage, int tIndex, int tPShopItemInfo[9] )
{
...
//B_BUY_PSHOP_RECV
void MyTransfer::B_BUY_PSHOP_RECV( int tResult, int tCost, int tPage, int tIndex, int tValue[6] )
{
...
void MyTransfer::B_GENERAL_CHAT_RECV( char tAvatarName[MAX_AVATAR_NAME_LENGTH], BYTE tAuthType, char tContent[MAX_CHAT_CONTENT_LENGTH] )
{
	...
	CopyMemory( &mOriginal[1 + MAX_AVATAR_NAME_LENGTH], &tAuthType, 1 );
	CopyMemory( &mOriginal[( 2 + MAX_AVATAR_NAME_LENGTH )], &tContent[0], MAX_CHAT_CONTENT_LENGTH );
	mOriginalSize = S_GENERAL_CHAT_RECV;
}
//B_SECRET_CHAT_RECV
void MyTransfer::B_SECRET_CHAT_RECV( int tResult, int tZoneNumber, char tAvatarName[MAX_AVATAR_NAME_LENGTH], char tContent[MAX_CHAT_CONTENT_LENGTH], BYTE tAuthType, int type )
{
	if(type == 0) {
...
void MyTransfer::B_BUY_CASH_ITEM_RECV( int tResult, int tCashSize, int tBonusCashSize, int tPage, int tIndex, int tValue[6] )
{
	...
	CopyMemory( &mOriginal[13], &tPage, 4 );
	CopyMemory( &mOriginal[17], &tIndex, 4 );
	CopyMemory( &mOriginal[21], &tValue[0], 24 );
...
//B_TRADE_START_RECV
void MyTransfer::B_TRADE_START_RECV( int tTradeMoney, int tTrade[MAX_TRADE_SLOT_NUM][4] )
{
...
//B_TRADE_STATE_RECV
void MyTransfer::B_TRADE_STATE_RECV( int tTradeMoney, int tTrade[MAX_TRADE_SLOT_NUM][4] )
{
...
//B_PARTY_MAKE_RECV
void MyTransfer::B_PARTY_MAKE_RECV( void )
{
...
//B_PARTY_INFO_RECV
void MyTransfer::B_PARTY_INFO_RECV( char tAvatarName01[MAX_AVATAR_NAME_LENGTH], char tAvatarName02[MAX_AVATAR_NAME_LENGTH], char tAvatarName03[MAX_AVATAR_NAME_LENGTH], char tAvatarName04[MAX_AVATAR_NAME_LENGTH], char tAvatarName05[MAX_AVATAR_NAME_LENGTH], int type )
{
	if(type == 0) {
		...
		CopyMemory( &mOriginal[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName03[0], MAX_AVATAR_NAME_LENGTH );
		CopyMemory( &mOriginal[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName04[0], MAX_AVATAR_NAME_LENGTH );
		CopyMemory( &mOriginal[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName05[0], MAX_AVATAR_NAME_LENGTH );
		...
		CopyMemory( &mOriginal_C[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName03[0], MAX_AVATAR_NAME_LENGTH );
		CopyMemory( &mOriginal_C[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName04[0], MAX_AVATAR_NAME_LENGTH );
		CopyMemory( &mOriginal_C[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName05[0], MAX_AVATAR_NAME_LENGTH );
		...
		CopyMemory( &mOriginal_R[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName03[0], MAX_AVATAR_NAME_LENGTH );
		CopyMemory( &mOriginal_R[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName04[0], MAX_AVATAR_NAME_LENGTH );
		CopyMemory( &mOriginal_R[( 1 + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], &tAvatarName05[0], MAX_AVATAR_NAME_LENGTH );
...
//B_TRIBE_NOTICE_RECV
void MyTransfer::B_TRIBE_NOTICE_RECV( char tAvatarName[MAX_AVATAR_NAME_LENGTH], char tContent[MAX_CHAT_CONTENT_LENGTH], int type )
{
	if(type == 0) {
...
void MyTransfer::B_ITEM_LIKE_1336_RECV(int *tCount, int *tPage, int *tInvenSlot, int *tInvenIndex, int (*tItemList)[2], int *tItemValue, int *tItemRecognitionNum)
{
	int index01 = 0;
...
// @ Cost Info Download @
void MyTransfer::B_GET_CASH_ITEM_INFO_RECV(int tResult, int tVersion, const int tCashItemInfo[4][10][10][4])
{

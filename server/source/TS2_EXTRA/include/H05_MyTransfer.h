...
public :
    ...
    // @ Cost Info Download @
    void B_ZONE_FOR_EXTRA_RECV(int tVersion, const int tCashItemInfo[4][10][10][4]);
    // @
    ...
    void B_GET_CASH_ITEM_INFO_FOR_EXTRA_RECV( int tResult, int tVersion, const int tCashItemInfo[4][10][10][4] );

    void UPDATE_CASH_FOR_EXTRA_RECV( int tCash );
    // @

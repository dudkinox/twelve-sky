...
// @ Cost Info Download @
void MyTransfer::B_ZONE_FOR_EXTRA_RECV(int tVersion, const int tCashItemInfo[4][10][10][4])
{
...
void MyTransfer::B_GET_CASH_ITEM_INFO_FOR_EXTRA_RECV( int tResult, int tVersion, const int tCashItemInfo[4][10][10][4] )
{

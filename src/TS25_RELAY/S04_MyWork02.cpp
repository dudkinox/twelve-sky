...
void W_DEMAND_BROADCAST_DATA(int tUserIndex)
{
	...
	case 104: //PARTY_JOIN
		...
		if (mWORK.map_party_list.end() == iter)
		{
			...
			CopyMemory(&tData[MAX_PARTY_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH], tParty_list.mPartyAvatarName[1],
			           MAX_AVATAR_NAME_LENGTH);
			CopyMemory(&tData[( MAX_PARTY_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )],
			           tParty_list.mPartyAvatarName[2], MAX_AVATAR_NAME_LENGTH);
			CopyMemory(
				&tData[( MAX_PARTY_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH +
					MAX_AVATAR_NAME_LENGTH )], tParty_list.mPartyAvatarName[3], MAX_AVATAR_NAME_LENGTH);
			CopyMemory(
				&tData[( MAX_PARTY_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH +
					MAX_AVATAR_NAME_LENGTH + MAX_AVATAR_NAME_LENGTH )], tParty_list.mPartyAvatarName[4],
				MAX_AVATAR_NAME_LENGTH);
		}
		else
		{
	...
	case 107: //PARTY_EXILE
		...
		if (mWORK.map_party_list.end() != iter)
		{
			for (index01 = 0; index01 < 5; ++index01)
			{
				...
				{
					strncpy(iter->second.mPartyAvatarName[index01], iter->second.mPartyAvatarName[index01 + 1],
					        MAX_AVATAR_NAME_LENGTH);
	...
	case 109: //PARTY_BREAK
		...
		if (mWORK.map_party_list.end() != iter)
		{
			...
			{
				strncpy(tParty_list.mPartyAvatarName[index01 - 1], tParty_list.mPartyAvatarName[index01],
				        MAX_AVATAR_NAME_LENGTH);

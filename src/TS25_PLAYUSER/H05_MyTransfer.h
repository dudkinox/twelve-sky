...
public :
	...
	void B_REGISTER_USER_FOR_ZONE_1_RECV(int tResult, int tUserSort, AVATAR_INFO* tAvatarInfo,
	...
	void B_USER_INFO_FOR_POLICE(char tID[33], char tIP[16], char tLoginState);
	void B_USER_INFO_FOR_POLICE2(char tID[33], char tIP[16], char tLoginState);
};

...
private :
	...
	void MakeQueryForSave(int tSort, char tID[MAX_USER_ID_LENGTH], AVATAR_INFO* tAvatarInfo);
...
public :
	...
	BOOL DB_PROCESS_03(int tSort, char tID[MAX_USER_ID_LENGTH], AVATAR_INFO* tAvatarInfo, AUTH_INFO* tAuthInfo);
	...
	BOOL DB_PROCESS_08(char tID[MAX_USER_ID_LENGTH], char tAvatarName[MAX_AVATAR_NAME_LENGTH], int tWorldNumber,
	                   int tZoneNumber);
	...
	void DB_PROCESS_11(char tID[MAX_USER_ID_LENGTH], char tAvatarName[MAX_AVATAR_NAME_LENGTH],

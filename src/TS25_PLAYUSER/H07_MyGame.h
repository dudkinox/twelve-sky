...
public :
	...
	int mLoginPlace[MAX_PLAY_USER_NUM];
	...
	int mPremiumServerExpirationDate[MAX_PLAY_USER_NUM];
	...
	void ProcessForSave_1(int tSort, char tID[MAX_USER_ID_LENGTH], AVATAR_INFO* tAvatarInfo, AUTH_INFO* tAuthInfo);
	...
	int RegisterUserForLogin_01(char tIP[16], char tID[MAX_USER_ID_LENGTH], int tUserSort, int* tPlayUserIndex,
	                            AUTH_INFO* tAuthInfo);
	...
	int RegisterUserForZone_01(int tZoneNumber, int tPlayUserIndex, char tID[MAX_USER_ID_LENGTH],
	                           ...
	                           AUTH_INFO* tAuthInfo);
	// 함수 선언 수정 - int *tPremiumServerExpirationDate 추가. // @_Premium_Server_@
	int RegisterUserForZone_02(int tZoneNumber, int tPlayUserIndex, char tID[MAX_USER_ID_LENGTH],
	                           AVATAR_INFO* tAvatarInfo, int tEffectValue[MAX_AVATAR_EFFECT_SORT_NUM][2],
	                           AUTH_INFO* tAuthInfo);
	int RegisterUserForZone_03(int tZoneNumber, int tPlayUserIndex, char tID[MAX_USER_ID_LENGTH],
	                           AVATAR_INFO* tAvatarInfo, int tEffectValue[MAX_AVATAR_EFFECT_SORT_NUM][2],
	                           AUTH_INFO* tAuthInfo);
	void UnRegisterUserForZone(int tZoneNumber, int tPlayUserIndex, char tID[MAX_USER_ID_LENGTH],

...
public :
	...
	// @ Cost Info Download @
	// 진열 구분 추가.
	int mCostInfoValue[MAX_COST_INFO_NUM][MAX_COST_INFO_TYPE];
	//[0]::가격,[1]::아이템,[2]::수량,[3]::판매여부,[4]::진열구분(1기능, 2보조, 3장식, 4잡화)
	...
	bool LoadCostInfo(int* pTotalCostInfoNum, int* pVersion, int tCostInfoValue[MAX_COST_INFO_NUM][MAX_COST_INFO_TYPE],
	                  char tCostInfoCode[MAX_COST_INFO_NUM][MAX_COST_INFO_CODE_LEN]);
	bool MakeCashItemInfo(int tCashItemInfo[4][14][10][4],

...
BOOL MyWork::Init(void)
{
	...
	//W_COSTUME_STATE
	mWorkerPacketSize[P_COSTUME_SEND] = S_COSTUME_SEND;
	W_FUNCTION[P_COSTUME_SEND].PROC = W_COSTUME_STATE_RECV;
	//W_TRIBE_WORK_SEND
	...
	mWorkerPacketSize[P_NPC_FUNCTION_SEND] = S_NPC_FUNCTION_SEND;
	W_FUNCTION[P_NPC_FUNCTION_SEND].PROC = W_NPC_FUNCTION_SEND;
	...
	//Hero Ranking DC issue
	mWorkerPacketSize[118] = 9;
	W_FUNCTION[118].PROC = W_HERO_RANKING_SEND;
	return TRUE;
}

...
BOOL MyWork::ProcessForGetItem(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2, int tIndex2,
                               int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > (MAX_ITEM_OBJECT_NUM - 1)) || (tPage2 < 0) || (tPage2 > 1) || (tIndex2 < 0) || (
		tIndex2 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tXPost2 < 0) || (tXPost2 > 7) || (tYPost2 < 0) || (tYPost2 > 7))
	{
	...
	if ((!tITEM_OBJECT->mCheckValidState) || (static_cast<int>(tITEM_OBJECT->mUniqueNumber) != tIndex1))
	{
		*tResult = 1;
		return TRUE;
	}
	...
	// 1417, an item dropped by event boss monsters (raid monsters), is
	// Modified so that only one can be obtained.
	...
	case 2:
		...
		if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] > 0)
		{
			...
			if ((mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][3] + tITEM_OBJECT->mDATA.iQuantity) >
				MAX_ITEM_DUPLICATION_NUM)
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
			}
		}
		GameLogger(1, "<GAIN_ITEM>(%s),(%s), (ITEM),(%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, tITEM_OBJECT->mDATA.iIndex, tITEM_OBJECT->mDATA.iQuantity,
		           tITEM_OBJECT->mDATA.iValue, tITEM_OBJECT->mDATA.iItemRecognitionNumber, mSERVER_INFO.mServerNumber);
	...
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage2][tIndex2] = 0;
	// Transfer Done
		*tResult = 0;
		return TRUE;
	}
...
BOOL MyWork::ProcessForSkillToHotKey(int tUserIndex, int tSkillSort, int tSkillIndex, int tSkillGrade, int tHotKeyPage,
                                     int tHotKeyIndex, int* tResult)
{
	switch (tSkillSort)
	{
	case 1:
		if ((tSkillIndex < 0) || (tSkillIndex > (MAX_SKILL_SLOT_NUM - 1)) || (tSkillGrade < 1) || (tHotKeyPage < 0) || (
			tHotKeyPage > 2) || (tHotKeyIndex < 0) || (tHotKeyIndex > (MAX_HOT_KEY_NUM - 1)))
		{
			mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
			return FALSE;
		}
		...
		mUSER[tUserIndex].mAvatarInfo.aHotKey[tHotKeyPage][tHotKeyIndex][0] = mUSER[tUserIndex].mAvatarInfo.aSkill[
			tSkillIndex][0];
		...
		*tResult = 0;
		return TRUE;
	case 2:
		if ((tSkillIndex < 1) || (tSkillIndex > 9) || (tHotKeyPage < 0) || (tHotKeyPage > 2) || (tHotKeyIndex < 0) || (
			tHotKeyIndex > (MAX_HOT_KEY_NUM - 1)))
		{
			mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
			return FALSE;
		}
...
BOOL MyWork::ProcessForHotKeyToNo(int tUserIndex, int tHotKeyPage, int tHotKeyIndex, int* tResult)
{
	...
	if ((mUSER[tUserIndex].mAvatarInfo.aHotKey[tHotKeyPage][tHotKeyIndex][2] != 1) && (mUSER[tUserIndex].mAvatarInfo.
		aHotKey[tHotKeyPage][tHotKeyIndex][2] != 2))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	}
...
BOOL MyWork::ProcessForInventoryToInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                            int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tPage2 < 0) || (
		tPage2 > 1) || (tIndex2 < 0) || (tIndex2 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tXPost2 < 0) || (tXPost2 > 7) || (
		tYPost2 < 0) || (tYPost2 > 7))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	...
	case 2:
		...
		if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] > 0)
		{
			if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aInventory
				[tPage1][tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][0];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][1] = tXPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][2] = tYPost2;
	...
	default:
		...
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][1] = tXPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][2] = tYPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][3] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][3];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][4] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][4];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][5] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][5];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0] = 0;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][1] = 0;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][2] = 0;
		...
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage2][tIndex2] = mUSER[tUserIndex].mAvatarInfo.aInventorySocket
			[tPage1][tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage1][tIndex1] = 0;
	// Transfer Done
		*tResult = 0;
		return TRUE;
	}
...
BOOL MyWork::ProcessForInventoryToWorld(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                        int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	...
	// 2009.08.05
		if (!mUTIL.ProcessForDropItem(3, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0], tQuantity1, 0, 0,
		...
		GameLogger(1, "<DROP_ITEM>(%s),(%s), (%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
	...
	default:
		// 2009.08.05
		if (!mUTIL.ProcessForDropItem(3, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0],
		                              mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3],
		                              mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4],
		                              mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5],
		                              &mAVATAR_OBJECT[tUserIndex].mDATA.aAction.aLocation[0],
		                              &mUSER[tUserIndex].mAvatarInfo.aName[0], 0))
		{
			*tResult = 1;
...
BOOL MyWork::ProcessForInventoryToEquip(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                        int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tIndex2 < 0) || (
		tIndex2 > (MAX_EQUIP_SLOT_NUM - 1)))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	}
	...
	if (!mUTIL.CheckPossibleEquipItem(mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0],
	                                  mUSER[tUserIndex].mAvatarInfo.aPreviousTribe, tIndex2,
	...
	mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5] = 0;
	// Transfer Socket
	mUSER[tUserIndex].mAvatarInfo.aEquipSocket[tIndex2] = mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage1][
		tIndex1];
	mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage1][tIndex1] = 0;
	// Transfer Done
...
BOOL MyWork::ProcessForInventoryToHotKey(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                         int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tPage2 < 0) || (
		tPage2 > 2) || (tIndex2 < 0) || (tIndex2 > (MAX_HOT_KEY_NUM - 1)))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	}
	...
	case 2:
		...
		{
			if (mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aInventory[
				tPage1][tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][0];
...
BOOL MyWork::ProcessForInventoryToNPCShop(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                          int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_INVENTORY_SLOT_NUM - 1)))
	{
	...
	case 2:
		...
		GameLogger(1, "<NPC_SELL_ITEM>(%s),(%s), (%d, %d, %d, %d),(SellPrice: %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5], tITEM_INFO->iSellCost,
...
BOOL MyWork::ProcessForEquipToInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                        int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tIndex1 < 0) || (tIndex1 > (MAX_EQUIP_SLOT_NUM - 1)) || (tPage2 < 0) || (tPage2 > 1) || (tIndex2 < 0) || (
		tIndex2 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tXPost2 < 0) || (tXPost2 > 7) || (tYPost2 < 0) || (tYPost2 > 7))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	...
	// Transfer Socket
	mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage2][tIndex2] = mUSER[tUserIndex].mAvatarInfo.aEquipSocket[
		tIndex1];
	mUSER[tUserIndex].mAvatarInfo.aEquipSocket[tIndex1] = 0;
	// Transfer Done
...
BOOL MyWork::ProcessForHotKeyToInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                         int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 2) || (tIndex1 < 0) || (tIndex1 > (MAX_HOT_KEY_NUM - 1)) || (tPage2 < 0) || (tPage2 >
		1) || (tIndex2 < 0) || (tIndex2 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tXPost2 < 0) || (tXPost2 > 7) || (tYPost2 <
		0) || (tYPost2 > 7))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	...
	if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] > 0)
	{
		if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aHotKey[
			tPage1][tIndex1][0])
		{
			mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
			return FALSE;
	...
	mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage1][
		tIndex1][0];
	mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][1] = tXPost2;
	mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][2] = tYPost2;
	mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][3] += tQuantity1;
...
BOOL MyWork::ProcessForNPCShopToInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                          int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage2 < 0) || (tPage2 > 1) || (tIndex2 < 0) || (tIndex2 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tXPost2 < 0) || (
	...
	case 2:
		...
		GameLogger(1, "<NPC_BUY_ITEM>(%s),(%s), (%d, %d, %d, %d),(BuyPrice: %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, tIndex1, tQuantity1, 0, 0, tITEM_INFO->iBuyCost,
		           mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForHotKeyToHotKey(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2, int tIndex2,
                                      int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 2) || (tIndex1 < 0) || (tIndex1 > (MAX_HOT_KEY_NUM - 1)) || (tPage2 < 0) || (tPage2 >
		2) || (tIndex2 < 0) || (tIndex2 > (MAX_HOT_KEY_NUM - 1)))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	}
	...
	case 2:
		...
		mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage1][
			tIndex1][0];
		mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage2][tIndex2][1] = mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage1][
			tIndex1][1];
		mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage2][tIndex2][2] = mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage1][
			tIndex1][2];
		mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage1][tIndex1][0] = 0;
		mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage1][tIndex1][1] = 0;
		mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage1][tIndex1][2] = 0;
	...
	case 3:
		...
		if (mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage2][tIndex2][2] == 3)
		{
			if (mUSER[tUserIndex].mAvatarInfo.aHotKey[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aHotKey[
				tPage1][tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
...
BOOL MyWork::ProcessForInventoryMoneyToWorld(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                             int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	if (!mUTIL.ProcessForDropItem(3, 1, tQuantity1, 0, 0, &mAVATAR_OBJECT[tUserIndex].mDATA.aAction.aLocation[0],
	                              &mUSER[tUserIndex].mAvatarInfo.aName[0], 0))
	{
		*tResult = 1;
		return TRUE;
...
BOOL MyWork::ProcessForInventoryToTrade(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                        int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tIndex2 < 0) || (
		tIndex2 > (MAX_TRADE_SLOT_NUM - 1)))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	}
	...
	case 2:
		...
		{
			if (mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
				tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		GameLogger(1, "<INVEN->TRADE>(%s),(%s), (%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5], mSERVER_INFO.mServerNumber);
	...
	//mGAMELOG.GL_622_TRADESLOT_ITEM(tUserIndex, 1, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5]);
		...
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aTradeSocket[tIndex2] = mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage1][
			tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage1][tIndex1] = 0;
	// Transfer Done
		mAVATAR_OBJECT[tUserIndex].ProcessForTradeInfo();
...
BOOL MyWork::ProcessForTradeToInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                        int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tIndex1 < 0) || (tIndex1 > (MAX_TRADE_SLOT_NUM - 1)) || (tPage2 < 0) || (tPage2 > 1) || (tIndex2 < 0) || (
		tIndex2 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tXPost2 < 0) || (tXPost2 > 7) || (tYPost2 < 0) || (tYPost2 > 7))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	...
	case 2:
		...
		if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] > 0)
		{
			if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aTrade[
				tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		GameLogger(1, "<TRADE->INVEN>(%s),(%s), (%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][0],
		           mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][1], mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][2],
		           mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][3], mSERVER_INFO.mServerNumber);
	...
	//mGAMELOG.GL_622_TRADESLOT_ITEM(tUserIndex, 2, mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][0], mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][1], mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][2], mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][3]);
		...
		mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][3] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage2][tIndex2] = mUSER[tUserIndex].mAvatarInfo.aTradeSocket[
			tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aTradeSocket[tIndex1] = 0;
	// Transfer Done
		mAVATAR_OBJECT[tUserIndex].ProcessForTradeInfo();
		*tResult = 0;
		return TRUE;
...
BOOL MyWork::ProcessForTradeToTrade(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2, int tIndex2,
                                    int tXPost2, int tYPost2, int* tResult)
{
	...
	default:
		...
		mUSER[tUserIndex].mAvatarInfo.aTrade[tIndex1][3] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aTradeSocket[tIndex2] = mUSER[tUserIndex].mAvatarInfo.aTradeSocket[tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aTradeSocket[tIndex1] = 0;
	// Transfer Done
		mAVATAR_OBJECT[tUserIndex].ProcessForTradeInfo();
		*tResult = 0;
...
BOOL MyWork::ProcessForInventoryMoneyToTradeMoney(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                  int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<MONEY->TRADEMONEY>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForTradeMoneyToInventoryMoney(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                  int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<TRADEMONEY->MONEY>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForInventoryMoney2ToTradeMoney2(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                    int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<MONEY2->TRADEMONEY2>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForTradeMoney2ToInventoryMoney2(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                    int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<TRADEMONEY2->MONEY2>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
	mUSER[tUserIndex].mAvatarInfo.aTradeMoney2 -= tQuantity1;
	mUSER[tUserIndex].mAvatarInfo.aMoney2 += tQuantity1;
	mAVATAR_OBJECT[tUserIndex].ProcessForTradeInfo();
...
BOOL MyWork::ProcessForInventoryToStore(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                        int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tPage2 < 0) || (
		tPage2 > 1) || (tIndex2 < 0) || (tIndex2 > (MAX_STORE_ITEM_SLOT_NUM - 1)))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	}
	...
	case 2:
		...
		{
			if (mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aInventory
				[tPage1][tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		GameLogger(1, "<INVEN->STORE>(%s),(%s), (%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5], mSERVER_INFO.mServerNumber);
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][0];
	...
	//mGAMELOG.GL_624_STROESLOT_ITEM(tUserIndex, 1, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5]);
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][0];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][1] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][3];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][2] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][4];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][3] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
			tIndex1][5];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0] = 0;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][1] = 0;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][2] = 0;
		...
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aStoreSocket[tPage2][tIndex2] = mUSER[tUserIndex].mAvatarInfo.aInventorySocket[
			tPage1][tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage1][tIndex1] = 0;
	// Transfer Done
		*tResult = 0;
...
BOOL MyWork::ProcessForInventoryToPetInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                               int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	...
	GameLogger(1, "<INVEN->PETINVENTORY>(%s),(%s), (%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0],
	           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3],
	           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4],
	           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5], mSERVER_INFO.mServerNumber);
	mUSER[tUserIndex].mAvatarInfo.aPetInventoryData[tPage2] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][
		0];
	mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0] = 0;
	mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][1] = 0;
	mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][2] = 0;
...
BOOL MyWork::ProcessForPetInventoryToInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                               int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	...
	GameLogger(1, "<PETINVENTORY->INVENTORY>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aPetInventoryData[tIndex1],
	           mSERVER_INFO.mServerNumber);
	mUSER[tUserIndex].mAvatarInfo.aInventory[tQuantity1][tPage2][0] = mUSER[tUserIndex].mAvatarInfo.aPetInventoryData[
		tIndex1];
...
BOOL MyWork::ProcessForPetInventoryToPetInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                  int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	/*if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tPage2 < 0) || (tPage2 > 1) || (tIndex2 < 0) || (tIndex2 > (MAX_STORE_ITEM_SLOT_NUM - 1)))
	{
	...
	GameLogger(1, "<PETINVENTORY->PETINVENTORY>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aPetInventoryData[tIndex1],
	           mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForStoreToInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                        int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_STORE_ITEM_SLOT_NUM - 1)) || (tPage2 < 0) || (
		tPage2 > 1) || (tIndex2 < 0) || (tIndex2 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tXPost2 < 0) || (tXPost2 > 7) || (
		tYPost2 < 0) || (tYPost2 > 7))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
	...
	case 2:
		...
		if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] > 0)
		{
			if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aStoreItem
				[tPage1][tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		GameLogger(1, "<STORE->INVEN>(%s),(%s), (%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][0],
		           mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][1],
		           mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][2],
		           mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][3], mSERVER_INFO.mServerNumber);
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][0];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][1] = tXPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][2] = tYPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][3] += tQuantity1;
	...
	//mGAMELOG.GL_624_STROESLOT_ITEM(tUserIndex, 2, mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][0], mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][1], mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][2], mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][3]);
		...
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][1] = tXPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][2] = tYPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][3] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][1];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][4] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][2];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][5] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][3];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][0] = 0;
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][1] = 0;
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][2] = 0;
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][3] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage2][tIndex2] = mUSER[tUserIndex].mAvatarInfo.aStoreSocket[
			tPage1][tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aStoreSocket[tPage1][tIndex1] = 0;
	// Transfer Done
		*tResult = 0;
		return TRUE;
	}
...
BOOL MyWork::ProcessForStoreToStore(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2, int tIndex2,
                                    int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_STORE_ITEM_SLOT_NUM - 1)) || (tPage2 < 0) || (
		tPage2 > 1) || (tIndex2 < 0) || (tIndex2 > (MAX_STORE_ITEM_SLOT_NUM - 1)))
	...
	case 2:
		...
		if (mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][0] > 0)
		{
			if (mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aStoreItem
				[tPage1][tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][0];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][1] += tQuantity1;
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][2] = 0;
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][3] = 0;
	...
	default:
		...
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][0];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][1] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][1];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][2] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][2];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage2][tIndex2][3] = mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][
			tIndex1][3];
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][0] = 0;
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][1] = 0;
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][2] = 0;
		mUSER[tUserIndex].mAvatarInfo.aStoreItem[tPage1][tIndex1][3] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aStoreSocket[tPage2][tIndex2] = mUSER[tUserIndex].mAvatarInfo.aStoreSocket[tPage1]
			[tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aStoreSocket[tPage1][tIndex1] = 0;
	// Transfer Done
		*tResult = 0;
...
BOOL MyWork::ProcessForInventoryMoneyToInventoryMoney2(int tUserIndex, int tPage1, int tIndex1, int tQuantity1,
                                                       int tPage2, int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
	...
	GameLogger(1, "<MONEY->MONEY2>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID, mUSER[tUserIndex].mAvatarInfo.aName,
	           tQuantity1, mSERVER_INFO.mServerNumber);
	mUSER[tUserIndex].mAvatarInfo.aMoney2 += tQuantity1 / tQuantity1;
	mUSER[tUserIndex].mAvatarInfo.aMoney -= tQuantity1;
	*tResult = 0;
	return TRUE;
}
...
BOOL MyWork::ProcessForInventoryMoney2ToInventoryMoney(int tUserIndex, int tPage1, int tIndex1, int tQuantity1,
                                                       int tPage2, int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
...
BOOL MyWork::ProcessForInventoryMoneyToStoreMoney(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                  int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<MONEY->STOREMONEY>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForStoreMoneyToInventoryMoney(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                  int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<STOREMONEY->MONEY>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForInventoryMoney2ToStoreMoney2(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                    int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<MONEY2->STOREMONEY2>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
	mUSER[tUserIndex].mAvatarInfo.aMoney2 -= tQuantity1;
...
BOOL MyWork::ProcessForStoreMoney2ToInventoryMoney2(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                    int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<STOREMONEY2->MONEY2>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
	mUSER[tUserIndex].mAvatarInfo.aStoreMoney2 -= tQuantity1;
	mUSER[tUserIndex].mAvatarInfo.aMoney2 += tQuantity1;
	*tResult = 0;
...
BOOL MyWork::ProcessForSaveMoney2ToInventoryMoney2(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                   int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<SAVEMONEY2->MONEY2>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForInventoryMoney2ToSaveMoney2(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                   int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<MONEY2->SAVEMONEY2>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
	mUSER[tUserIndex].mAvatarInfo.aMoney2 -= tQuantity1;
	mUSER[tUserIndex].mAvatarInfo.uSaveMoney2 += tQuantity1;
	*tResult = 0;
...
BOOL MyWork::ProcessForInventoryToSave(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2, int tIndex2,
                                       int tXPost2, int tYPost2, int* tResult)
{
	if ((tPage1 < 0) || (tPage1 > 1) || (tIndex1 < 0) || (tIndex1 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tIndex2 < 0) || (
		tIndex2 > (MAX_SAVE_ITEM_SLOT_NUM - 1)))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	}
	...
	case 2:
		...
		{
			if (mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][
				tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		GameLogger(1, "<INVEN->SAVE>(%s),(%s), (%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4],
		           mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5], mSERVER_INFO.mServerNumber);
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][
			0];
	...
	//mGAMELOG.GL_626_SAVESLOT_ITEM(tUserIndex, 1, mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][3], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][4], mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5]);
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][
			0];
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][1] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][
			3];
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][2] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][
			4];
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][3] = mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][
			5];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][0] = 0;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][1] = 0;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][2] = 0;
		...
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage1][tIndex1][5] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aSaveSocket[tIndex2] = mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage1][
			tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage1][tIndex1] = 0;
	// Transfer Done
		*tResult = 0;
...
BOOL MyWork::ProcessForSaveToInventory(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2, int tIndex2,
                                       int tXPost2, int tYPost2, int* tResult)
{
	if ((tIndex1 < 0) || (tIndex1 > (MAX_SAVE_ITEM_SLOT_NUM - 1)) || (tPage2 < 0) || (tPage2 > 1) || (tIndex2 < 0) || (
		tIndex2 > (MAX_INVENTORY_SLOT_NUM - 1)) || (tXPost2 < 0) || (tXPost2 > 7) || (tYPost2 < 0) || (tYPost2 > 7))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	...
	case 2:
		...
		if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] > 0)
		{
			if (mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.uSaveItem[
				tIndex1][0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		GameLogger(1, "<SAVE->INVEN>(%s),(%s), (%d, %d, %d, %d),[[%d]]", mUSER[tUserIndex].uID,
		           mUSER[tUserIndex].mAvatarInfo.aName, mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][0],
		           mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][1],
		           mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][2],
		           mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][3], mSERVER_INFO.mServerNumber);
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][0] = mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][
			0];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][1] = tXPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][2] = tYPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][3] += tQuantity1;
	...
	//mGAMELOG.GL_626_SAVESLOT_ITEM(tUserIndex, 2, mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][0], mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][1], mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][2], mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][3]);
		...
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][1] = tXPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][2] = tYPost2;
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][3] = mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][
			1];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][4] = mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][
			2];
		mUSER[tUserIndex].mAvatarInfo.aInventory[tPage2][tIndex2][5] = mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][
			3];
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][0] = 0;
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][1] = 0;
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][2] = 0;
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][3] = 0;
	// Transfer Socket
		mUSER[tUserIndex].mAvatarInfo.aInventorySocket[tPage2][tIndex2] = mUSER[tUserIndex].mAvatarInfo.aSaveSocket[
			tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aSaveSocket[tIndex1] = 0;
	// Transfer Done
		*tResult = 0;
		return TRUE;
	}
...
BOOL MyWork::ProcessForSaveToSave(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2, int tIndex2,
                                  int tXPost2, int tYPost2, int* tResult)
{
	if ((tIndex1 < 0) || (tIndex1 > (MAX_SAVE_ITEM_SLOT_NUM - 1)) || (tIndex2 < 0) || (tIndex2 > (MAX_SAVE_ITEM_SLOT_NUM
		- 1)))
	{
		mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
		return FALSE;
	...
	case 2:
		...
		if (mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][0] > 0)
		{
			if (mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][0] != mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][
				0])
			{
				mUSER[tUserIndex].Quit(__FILE__, __FUNCTION__, __LINE__);
				return FALSE;
		...
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex2][3] = 0;
		mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][1] -= tQuantity1;
		mUSER[tUserIndex].mAvatarInfo.aSaveSocket[tIndex2] = mUSER[tUserIndex].mAvatarInfo.aSaveSocket[tIndex1];
		mUSER[tUserIndex].mAvatarInfo.aSaveSocket[tIndex1] -= tQuantity1;
		if (mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][1] < 1)
		{
			mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][0] = 0;
			mUSER[tUserIndex].mAvatarInfo.uSaveItem[tIndex1][1] = 0;
...
BOOL MyWork::ProcessForInventoryMoneyToSaveMoney(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                 int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<MONEY->SAVEMONEY>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);
...
BOOL MyWork::ProcessForSaveMoneyToInventoryMoney(int tUserIndex, int tPage1, int tIndex1, int tQuantity1, int tPage2,
                                                 int tIndex2, int tXPost2, int tYPost2, int* tResult)
{
	if (tQuantity1 < 1)
	{
	...
	GameLogger(1, "<SAVEMONEY->MONEY>(%s),(%s), (%d),[[%d]]", mUSER[tUserIndex].uID,
	           mUSER[tUserIndex].mAvatarInfo.aName, tQuantity1, mSERVER_INFO.mServerNumber);

...
using WORLD_REGION_INFO = struct
{
	int mVALUE01;
	int mVALUE02;
	int mVALUE03;
...
public:
	...
	void SummonMonsterForSpecial(int tMonsterNumber, float tMonsterLocation[3], BOOL tCheckExistMonster,
	                             int tUserIndex = -1); // tUserIndex - 몬스터 소유자 index

...
public :
	...
	void B_LOGIN_RECV(int tResult, char tID[MAX_USER_ID_LENGTH], int tUserSort, int tSecondLoginSort,
	                  char tMousePassword[MAX_MOUSE_PASSWORD_LENGTH], char tFirstLogin = '0');
	...
	void B_DEMAND_ZONE_SERVER_INFO_1_RESULT(int tResult, char tIP[16], int tPort, int tZone);

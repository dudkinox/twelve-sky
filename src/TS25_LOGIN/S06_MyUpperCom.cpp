...
void MyPlayUserCom::U_REGISTER_USER_FOR_LOGIN_1_SEND(char tIP[16], char tID[MAX_USER_ID_LENGTH], int tUserSort,
                                                     int tGoodFellow, int tLoginPlace, int tLoginPremium,
                                                     int tLoginPremiumPCRoom, int tTraceState, char tBonus100Money,
                                                     int tPremiumServerExpirationDate,
                                                     AUTH_INFO* tAuthInfo)
// 함수 선언 변경 - int tPremiumServerExpirationDate 추가. // @_Premium_Server_@
{
	...
	CopyMemory(&mSendData[(17 + MAX_USER_ID_LENGTH + 4)], tAuthInfo, sizeof(AUTH_INFO));
...
void MyPlayUserCom::U_REGISTER_USER_FOR_LOGIN_3_SEND(int tPlayUserIndex, char tID[MAX_USER_ID_LENGTH],

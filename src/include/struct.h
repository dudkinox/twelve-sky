...
#define     PATCH_DEPLOYMENT_PHASE  4   // 0 ~ 4 ÆÐÄ¡ ´Ü°è
...
//FOR_PLAYUSER//
//------------//
#define MAX_ZONE_NUMBER_NUM											350//300
#define MIN_VALID_ZONE_NUMBER										1
#define MAX_VALID_ZONE_NUMBER										350//300
#define MAX_PLAY_USER_NUM											1000//3000
...
//FOR_RELAY//
//---------//
#define MAX_BROADCAST_DATA_SIZE										100//100
//---------//
//FOR_EXTRA//
//---------//
...
//FOR_GAMELOG//
//-----------//
#define MAX_GAMELOG_LENGTH											10000
//---------//
//FOR_LOGIN//
//---------//
...
#define SIZE_OF_AVATAR_INFO                                         7896
#define SIZE_OF_ACTION_INFO                                         72
#define SIZE_OF_OBJECT_FOR_AVATAR                                   556
#define SIZE_OF_WORLD_INFO											1252
#define SIZE_OF_TRIBE_INFO											2456
...
#define MAX_ITEM_OBJECT_NUM											3000
...
#define MAX_IMPROVE_ITEM_NUM_NEXT									50
#define MAX_ADD_ITEM_NUM											12


// 2009.11.19 : ±è¼º¼ö
// ¿µ¼ö ½Ã½ºÅÛÀÇ ¿µ¼ö ÀÌÀÌÅÛ ¹øÈ£ ¹× ¿µ¼ö¿¡ ÇØ´ç ÇÏ´Â ´É·ÂÄ¡ °è¼ö°ª Á¤ÀÇ


constexpr float ANIMAL_MOVE_RATE = 1.10f;
constexpr int ANIMAL_NUM_CRISTMAS = 1316;


#ifndef __TK__

constexpr int ANIMAL_BAB = 1453;

constexpr int ANIMAL_NUM_BAKHO = 1301;
constexpr int ANIMAL_NUM_DONWHOANG = 1302;
constexpr int ANIMAL_NUM_CHUNLOK = 1303;
constexpr int ANIMAL_NUM_CHUNGHO = 1304;
constexpr int ANIMAL_NUM_TWODON = 1305;
constexpr int ANIMAL_NUM_BAIKLOK = 1306;
constexpr int ANIMAL_NUM_CHUKHO = 1307;
constexpr int ANIMAL_NUM_SUNGDON = 1308;
constexpr int ANIMAL_NUM_SHINLOK = 1309;
constexpr int ANIMAL_NUM_BEAR1 = 1313;
constexpr int ANIMAL_NUM_BEAR2 = 1314;
constexpr int ANIMAL_NUM_BEAR3 = 1315;
constexpr int ANIMAL_NUM_FERRET1 = 1317;
constexpr int ANIMAL_NUM_FERRET2 = 1318;
constexpr int ANIMAL_NUM_FERRET3 = 1319;
constexpr int ANIMAL_NUM_BULL1 = 1320;
constexpr int ANIMAL_NUM_BULL2 = 1321;
constexpr int ANIMAL_NUM_BULL3 = 1322;
constexpr int ANIMAL_NUM_WOLF1 = 1323;
constexpr int ANIMAL_NUM_WOLF2 = 1324;
constexpr int ANIMAL_NUM_WOLF3 = 1325;
constexpr int ANIMAL_NUM_HAECHI1 = 1326;
constexpr int ANIMAL_NUM_HAECHI2 = 1327;
constexpr int ANIMAL_NUM_HAECHI3 = 1328;
constexpr int ANIMAL_NUM_BLACKLEO = 1329;
constexpr int ANIMAL_NUM_BLUELEO = 1330;
constexpr int ANIMAL_NUM_WHITELEO = 1331;

constexpr float ANIMAL_RATE_ONE_GRADE = 1.05f;
constexpr float ANIMAL_RATE_TWO_GRADE = 1.1f;
constexpr float ANIMAL_RATE_THREE_GRADE = 1.15f;
constexpr float ANIMAL_RATE_FOUR_GRADE = 1.20f;
#else
...
//-------------------------------------------------------------------------------------------------
using GRADE_INFO_FOR_SKILL = struct
{
	int sManaUse;
	int sRecoverInfo[2];
	int sStunAttack;
...
//QUEST_INFO
//-------------------------------------------------------------------------------------------------
#define	QUEST_SUBJECT_LENGTH		51
#define	QUEST_EMPTY					1
#define	QUEST_SPEECH_NUM			16
#define	QUEST_SPEECH_LENGTH			51
#define	QUEST_SPEECH_COLOR			3

using QUEST_INFO = struct
{
	int qIndex;
	char qSubject[QUEST_SUBJECT_LENGTH];
	char qEmpty[QUEST_EMPTY];
	int qCategory;
	int qStep;
	int qLevel;
	int qType;
	...
	int qReward[3][2];
	int qNextIndex;
	char qStartSpeech[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qStartSpeechColor[QUEST_SPEECH_COLOR];
	char qHurrySpeech[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qHurrySpeechColor[QUEST_SPEECH_COLOR];
	char qProcessSpeech1[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qProcessSpeech1Color[QUEST_SPEECH_COLOR];
	char qProcessSpeech2[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qProcessSpeech2Color[QUEST_SPEECH_COLOR];
	char qProcessSpeech3[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qProcessSpeech3Color[QUEST_SPEECH_COLOR];
	char qProcessSpeech4[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qProcessSpeech4Color[QUEST_SPEECH_COLOR];
	char qProcessSpeech5[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qProcessSpeech5Color[QUEST_SPEECH_COLOR];
	char qSuccessSpeech[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qSuccessSpeechColor[QUEST_SPEECH_COLOR];
	char qFailureSpeech[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qFailureSpeechColor[QUEST_SPEECH_COLOR];
	char qCallSpeech[QUEST_SPEECH_NUM][QUEST_SPEECH_LENGTH];
	int qCallSpeechColor[QUEST_SPEECH_COLOR];
};
//-------------------------------------------------------------------------------------------------
...
using AVATAR_INFO = struct
{
	...
	int uSaveMoney;
	int uSaveItem[28][4];
	char aPartyName[5][13]; // aPartyName[5][MAX_AVATAR_NAME_LENGTH] //Old was aUnk00003[17];
	int aCostume[10];
	...
	int aTimeEffect;
	int aTimeEffect2;
	int aInventorySocket[2][64];
	int aEquipSocket[13];
	int aTradeSocket[8];
	int aStoreSocket[2][28];
	int aSaveSocket[28];
	int aAutoHunt7Day;
	int aAutoHunt5Hour;
	//
	...
	int aUnkTimez3;
	int aUnkz;
	int aUnkzvc; // True End Struct
};

using AUTOBUFF_DATA = struct
{
	int aAutoBuffSkillSlots[8][2];
};

using HUNT_AUTO_INFO = struct
{
	int aAutoHuntUNK;
	int aAutoHuntData[8][2];
	int aStandStillOrMovingHunt;
...
using WORLD_INFO = struct
{
	...
	int mZone194State;
	int mUnknown2[6];
	int mRainbowIslandCaptureInfo[4][4];
	int mTribeMasterCallAbility[4];
	int mZone267TypeState[4];
	int mUnknown3[20];
	char mHoldingGuild[MAX_GUILD_NAME_LENGTH];
	char mChallangeGuild[MAX_GUILD_NAME_LENGTH];
	char mGuildRankName[3][MAX_GUILD_NAME_LENGTH];
	int mGuildRankPoints[3];
	int mUNKGUILD[5];
	char mBigForGuildName[4][MAX_GUILD_NAME_LENGTH];
	int stateUnk[58];
	int mZone200TypeState;
	int mProvingGroundsPoint[4];
	int mProvingGroundsState[4];
	int mZoneUNK[5];
	int mUknown11; //int mZone194State;
	int mZone267Old[4]; //int mZone267TypeState[4];
...
using TRIBE_INFO = struct
{
	...
	/* 	char mHoisundoName1[4][MAX_HOISUNDO_AVATAR_NUM][MAX_AVATAR_NAME_LENGTH];
    char mHoisundoName2[4][MAX_HOISUNDO_AVATAR_NUM][MAX_AVATAR_NAME_LENGTH];
    char mHoisundoName3[4][MAX_HOISUNDO_AVATAR_NUM][MAX_AVATAR_NAME_LENGTH];	*/
};
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
using ZONE_CONNECTION_INFO = struct
{
...
//PSHOP_INFO
//-------------------------------------------------------------------------------------------------
using PSHOP_INFO = struct
{
	DWORD mUniqueNumber;
	char mName[MAX_PSHOP_NAME_LENGTH];
	int mItemInfo[MAX_PSHOP_PAGE_NUM][MAX_PSHOP_SLOT_NUM][9];
	//[0]:..,[1]:..,[2]:..,[3]:..,[4]:..,[5]:mPage,[6]:mIndex,[7]:mXPost,[8]:mYPost
	int mItemSocket[5][5];
};
//-------------------------------------------------------------------------------------------------
...
//OBJECT_FOR_AVATAR
//-------------------------------------------------------------------------------------------------
using OBJECT_FOR_AVATAR = struct
{
	int aVisibleState;
	int aSpecialState;
	int aKillOtherTribe;
	...
	int aHalo;
	int aRebirth;
	int bStateDarkAttack; //aBatlleTeam
	ACTION_INFO aAction;
	int aMaxLifeValue;
	int aLifeValue;
	int aMaxManaValue;
...
// ÀÌµ¿¼­ »ç¿ë Á¤º¸.
using MOVE_ITEM_INFO = struct _MOVE_ITEM_INFO
{
	// ¸â¹ö °ªµéÀÌ -1ÀÌ¸é »ç¿ëÇÏÁö ¾ÊÀº °ÍÀÔ´Ï´Ù.
	int mZoneNumber; // ÀÌµ¿ÇÒ Á¸ ¹øÈ£.
	int mInvenPage; // ÀÌµ¿¼­ ¾ÆÀÌÅÛÀÌ À§Ä¡ÇÑ ÀÎº¥Åä¸® ÆäÀÌÁö.
	int mInvenIndex; // ÀÌµ¿¼­ ¾ÆÀÌÅÛÀÌ À§Ä¡ÇÑ ¹è¿­ index.
	int mInvenX; // ÀÌµ¿¼­ ¾ÆÀÌÅÛ xÁÂÇ¥.
	int mInvenY; // ÀÌµ¿¼­ ¾ÆÀÌÅÛ yÁÂÇ¥.
};
#pragma pack (pop)
...
//OBJECT_FOR_MONSTER
//-------------------------------------------------------------------------------------------------
using OBJECT_FOR_MONSTER = struct
{
	int mIndex;
	ACTION_INFO mAction;
	int mLifeValue;
...
//ATTACK_FOR_PROTOCOL
//-------------------------------------------------------------------------------------------------
using ATTACK_FOR_PROTOCOL = struct
{
	int mCase;
	int mServerIndex1;
...
//RANK_FOR_PROTOCOL
using rank_level_t = struct _s_rank_level
{
...
using rank_kill_t = struct _s_rank_kill
{
	char aName[MAX_AVATAR_NAME_LENGTH];
	int kill;
	int tribe;
...
using rank_info_t = struct _s_rank_info
{
	char aName[MAX_AVATAR_NAME_LENGTH];
	int level;
	int kill;
...
//protocol(1) + tPlayUserIndex(4) + tID(MAX_USER_ID_LENGTH) + tAvatarInfo( SIZE_OF_AVATAR_INFO )
#define P_REGISTER_USER_FOR_LOGIN_3_SEND							15
#define S_REGISTER_USER_FOR_LOGIN_3_SEND							5 + MAX_USER_ID_LENGTH + SIZE_OF_AVATAR_INFO
//protocol(1) + tPlayUserIndex(4) + tID(MAX_USER_ID_LENGTH)
...
//protocol(1) + tPlayUserIndex(4) + tID(MAX_USER_ID_LENGTH) + tAvatarInfo( SIZE_OF_AVATAR_INFO ) + tEffectValue(MAX_AVATAR_EFFECT_SORT_NUM * 8)
#define P_REGISTER_USER_FOR_ZONE_2_SEND								35
#define S_REGISTER_USER_FOR_ZONE_2_SEND								5 + MAX_USER_ID_LENGTH + SIZE_OF_AVATAR_INFO + (MAX_AVATAR_EFFECT_SORT_NUM * 8) + sizeof (AUTH_INFO)
//protocol(1) + tPlayUserIndex(4) + tID(MAX_USER_ID_LENGTH) + tAvatarInfo( SIZE_OF_AVATAR_INFO ) + tEffectValue(MAX_AVATAR_EFFECT_SORT_NUM * 8)
#define P_REGISTER_USER_FOR_ZONE_3_SEND								36
#define S_REGISTER_USER_FOR_ZONE_3_SEND								5 + MAX_USER_ID_LENGTH + SIZE_OF_AVATAR_INFO + (MAX_AVATAR_EFFECT_SORT_NUM * 8) + sizeof (AUTH_INFO)
//protocol(1) + tPlayUserIndex(4) + tID(MAX_USER_ID_LENGTH) + tAvatarInfo( SIZE_OF_AVATAR_INFO )
#define P_UNREGISTER_USER_FOR_ZONE_SEND								37
#define S_UNREGISTER_USER_FOR_ZONE_SEND								5 + MAX_USER_ID_LENGTH + SIZE_OF_AVATAR_INFO + sizeof (AUTH_INFO)
...
//protocol(1) + tResult(4) + tUserSort(4) + tGoodFellow(4) + tLoginPlace(4) + tLoginPremium(4) + tLoginPremiumPCRoom(4) + tTraceState(4) + tBonus100Money(1) + tPremiumServerExpirationDate(4) + tAvatarInfo( SIZE_OF_AVATAR_INFO ) + tEffectValue(MAX_AVATAR_EFFECT_SORT_NUM * 8) + tCheckFirstZone(4)
#define P_REGISTER_USER_FOR_ZONE_1_RECV								13
#define S_REGISTER_USER_FOR_ZONE_1_RECV								38 + SIZE_OF_AVATAR_INFO + (MAX_AVATAR_EFFECT_SORT_NUM * 8) + sizeof (AUTH_INFO) + sizeof(MOVE_ITEM_INFO) // + tPremiumServerExpirationDate(4) // @_Premium_Server_@ // + sizeof(MOVE_ITEM_INFO)
...
#define S_WORLD_INFO												1 + SIZE_OF_WORLD_INFO + SIZE_OF_TRIBE_INFO//sizeof( TRIBE_INFO )
...
#define S_ZONE_FOR_EXTRA_RECV										5 + 8960
// @
...
#define S_GET_CASH_SIZE_FOR_EXTRA_RECV								9//13
...
#define S_GET_CASH_ITEM_INFO_FOR_EXTRA_RECV                         9 + 8960
// @
//protocol(1) + tResult(4)
...
//tPacketNumber1(4) + tPacketNumber2(4) + protocol(1) + tAvatarPost(4) + tAvatarInfo( SIZE_OF_AVATAR_INFO )
#define P_CREATE_AVATAR_SEND										17
#define S_CREATE_AVATAR_SEND										13 + SIZE_OF_AVATAR_INFO
...
#define P_WANT_GIFT_SEND											25
#define S_WANT_GIFT_SEND											9
//tPacketNumber1(4) + tPacketNumber2(4) + protocol(1) + tAvatarPost(4)
...
#define S_RECOMMAND_WORLD_SEND                                      13
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
...
#define S_LOGIN_RECV												339
//protocol(1) + tAvatarInfo( SIZE_OF_AVATAR_INFO )
#define P_USER_AVATAR_INFO											12
#define S_USER_AVATAR_INFO											1 + SIZE_OF_AVATAR_INFO
...
//protocol(1) + tResult(4) + tAvatarInfo( SIZE_OF_AVATAR_INFO )
#define P_CREATE_AVATAR_RECV										17
#define S_CREATE_AVATAR_RECV										5 + SIZE_OF_AVATAR_INFO
//protocol(1) + tResult(4)
...
#define S_REGISTER_AVATAR_SEND										9 + MAX_USER_ID_LENGTH + MAX_AVATAR_NAME_LENGTH + SIZE_OF_ACTION_INFO
...
#define S_AVATAR_ACTION_SEND										9 + SIZE_OF_ACTION_INFO
//tPacketNumber1(4) + tPacketNumber2(4) + protocol(1) + tAction( sizeof( ACTION_INFO ) )
#define P_UPDATE_AVATAR_ACTION										16
#define S_UPDATE_AVATAR_ACTION										9 + SIZE_OF_ACTION_INFO
...
//HALO
#define P_MAKE_HALO_RFC												79
#define S_MAKE_HALO_RFC												113
//tPacketNumber1(4) + tPacketNumber2(4) + protocol(1) + tPShopInfo( sizeof( PSHOP_INFO ) )
#define P_START_PSHOP_SEND											31
#define S_START_PSHOP_SEND											13 + sizeof(PSHOP_INFO)//9 + sizeof( PSHOP_INFO )
//tPacketNumber1(4) + tPacketNumber2(4) + protocol(1)
...
// @ Cost Info Download @
// S_BUY_CASH_ITEM_SEND »çÀÌÁî º¯°æ 45 --> 49 (tVersion Æ÷ÇÔ)
...
//tPacketNumber1(4) + tPacketNumber2(4) + protocol(1) + tContent(MAX_CHAT_CONTENT_LENGTH)
#define P_TRIBE_CHAT_SEND											81//104
...
//costume	//tPacketNumber1(4) + tPacketNumber2(4) + protocol(1) + tSort(4) + tValue(4)
#define P_COSTUME_SEND												90
#define S_COSTUME_SEND												17
//Absorb_STATE
#define P_ABSORB_STATE_SEND											113
#define S_ABSORB_STATE_SEND											13
//Faction Notice Scroll
...
//NPC_TELEPORT
#define P_NPC_FUNCTION_SEND											 92
#define S_NPC_FUNCTION_SEND											 13
//PET_COMBINE_SEND
#define P_PET_COMBINE_SEND											88
#define S_PET_COMBINE_SEND											45
//GEAR_BREAK_SEND
#define P_GEAR_BREAK_SEND											89
#define S_GEAR_BREAK_SEND											17
//REFINE_GEAR_SEND
#define P_REFINE_SEND												102
#define S_REFINE_SEND												25
//TIME_EFFECT_SEND
#define P_TIME_EFFECT_SEND											97
#define S_TIME_EFFECT_SEND											13
//DAILY_MISSION_SEND
#define P_DAILY_MISSION_SEND										126
#define S_DAILY_MISSION_SEND										13
//WARLORD_V2_SEND
#define P_WARLORD_V2_SEND											93
#define S_WARLORD_V2_SEND											25
//SOCKET_ITEM_SEND
#define P_SOCKET_ITEM_SEND											98
#define S_SOCKET_ITEM_SEND											21
...
#define CTOZ_ACK_INCOMING_UDP_TYPE          912//92
...
/* Mir added 08.12.12 */
#define P_CHECK_EVENT_INFO_RECV                                     84
#define S_CHECK_EVENT_INFO_RECV                                      9

#define P_AUTO_CONFIG_SEND											99
#define S_AUTO_CONFIG_SEND											125

#define P_AUTOBUFF_REGISTER_SEND									94
#define S_AUTOBUFF_REGISTER_SEND									73

#define P_AUTOBUFF_SEND												95
#define S_AUTOBUFF_SEND												25
/* Mir end */
//tPacketNumber1(4) + tPacketNumber2(4) + protocol(1) + tAvatarName(MAX_AVATAR_NAME_LENGTH)
...
struct CTOZ_TOGGLE_STOPWATCH
{
	...
	U_RANDOM_AND_ENCRYPT_MAGIC m_iRandom2;
	BYTE m_bMagic;
	// Kind -   0 : Àå½Ä ÇØ¹æ ½Ã½ºÅÛ »ç¿ë.
	BYTE m_bKind;
	BYTE m_bUse; // 0 - ²ô±â, 1 - ÄÑ±â.
};
...
//protocol(1) + tAvatarInfo( SIZE_OF_AVATAR_INFO ) + tEffectValue(MAX_AVATAR_EFFECT_SORT_NUM * 8) + tPremiumServerExpirationDate(4)
#define P_REGISTER_AVATAR_RECV										12
#define S_REGISTER_AVATAR_RECV										1 + SIZE_OF_AVATAR_INFO + MAX_AVATAR_EFFECT_SORT_NUM * 8 // + tPremiumServerExpirationDate(4) // @_Premium_Server_@


//protocol(1) + tWorldInfo( sizeof( WORLD_INFO ) ) + tTribeInfo( sizeof( TRIBE_INFO ) )
#define P_BROADCAST_WORLD_INFO										13
#define S_BROADCAST_WORLD_INFO										1 + SIZE_OF_WORLD_INFO + SIZE_OF_TRIBE_INFO//sizeof( TRIBE_INFO )
...
#define S_AVATAR_ACTION_RECV										13 + SIZE_OF_OBJECT_FOR_AVATAR
...
//HALO RFC
//#define P_MAKE_HALO_RFC_RECV										88
//#define S_MAKE_HALO_RFC_RECV										9
...
#define S_GENERAL_SHOUT_RECV										75
//protocol(1) + tCashSize(4) + tBonusCashSize(4)
...
#define S_BUY_CASH_ITEM_RECV										41//45
...
//protocol(1)
#define P_GEAR_BREAK_RECV											106
#define S_GEAR_BREAK_RECV											33
//protocol(1)
#define P_REFINE_RECV												124
#define S_REFINE_RECV												13//9
//protocol(1)
#define P_DAILY_RECV												163
#define S_DAILY_RECV												25
...
#define S_TRADE_START_RECV											169//13 + MAX_TRADE_SLOT_NUM * 17
//protocol(1) + tTradeMoney(4) + tTrade(MAX_TRADE_SLOT_NUM * 16)
#define P_TRADE_STATE_RECV											56
#define S_TRADE_STATE_RECV											169//5 + MAX_TRADE_SLOT_NUM * 17
...
#define S_PARTY_BREAK_RECV											18//1 + MAX_AVATAR_NAME_LENGTH
//protocol(1) + tAvatarName(MAX_AVATAR_NAME_LENGTH)
...
#define P_051_TYPE_BATTLE_INFO										103
...
//protocol(1)
#define P_REMAIN_TIME_RECV											157
#define S_REMAIN_TIME_RECV											5
//protocol(1)
#define P_WARLORD_V2_RECV											112
#define S_WARLORD_V2_RECV											33
//protocol(1)
#define P_AUTOHUNT_RECV												123
#define S_AUTOHUNT_RECV												13
//protocol(1)
#define P_SOCKET_ITEM_RECV											117
#define S_SOCKET_ITEM_RECV											13
//protocol(1)
#define P_DAILY_GET_REWARD											119
#define S_DAILY_GET_REWARD											61
//protocol(1)
#define P_VOD_BATTLE_INFO											118
#define S_VOD_BATTLE_INFO											17
...
#define P_DEMAND_OBJECT_RECV										22
#define S_DEMAND_OBJECT_RECV										 9
/* Mir added 08.12.12 */
#define P_CHECK_EVENT_INFO_SEND										111
#define S_CHECK_EVENT_INFO_SEND                                      9
/* Mir end */
#define P_ZTOP_RANK_INFO_SEND                                      101
#define S_ZTOP_RANK_INFO_SEND                                      1 + sizeof(rank_info_t)

//protocol(1) + tValue01(4) + tValue02(4)
/*´º¿µ¼ö*/
#define P_ANIMAL_STATE_RECV											102//108
#define S_ANIMAL_STATE_RECV											9


#define P_ABSORB_STATE_RECV											22//108
#define S_ABSORB_STATE_RECV											9

#define P_FACTION_NOTICE_RECV										139
#define S_FACTION_NOTICE_RECV										5 + MAX_AVATAR_NAME_LENGTH + MAX_CHAT_CONTENT_LENGTH

//protocol(1) + tCount(4) + {tPage(4) + tInvenSlot(4) + tInvenIndex(4) + tItemNum(4) + tItemCount(4) + tItemValue(4) + tItemRecognitionNum(4)} * 5
#define P_ITEM_LIKE_1336_RECV										103
...
//protocol(1) + tRemainTime(4)
#define P_053_TYPE_BATTLE_INFO										104
...
#define S_GET_CASH_ITEM_INFO_RECV                                   8969//9 + MAX_CASH_ITEM_INFO_SIZE
//protocol(1)
...
#define P_194_BATTLE_INFO											100
#define S_194_BATTLE_INFO											17
//protocol(1) + tTime(4)
#define P_194_BATTLE_COUNTDOWN										101
#define S_194_BATTLE_COUNTDOWN										5

//protocol(1) + tTribeUserNum(16) + tRemainTime(4)
#define P_267_TYPE_BATTLE_INFO										95
